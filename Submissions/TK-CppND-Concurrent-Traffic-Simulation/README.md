...
In this project, we built a suitable and thread-safe communication protocol between vehicles and intersections to complete the simulation. 
...
When the project was built initially, all traffic lights were green. After the following tasks are implemented, the traffic simulation runs with red lights controlling traffic, just as in the .gif file above. 
The following tasks are completed to pass the project.
