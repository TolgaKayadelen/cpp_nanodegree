...
ChatLogic::~ChatLogic()
{
    ...
    // TASK 3: Don't need to explicitly delete any more as GraphNodes are
    // exclusively owned.
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // TASK 4: use move semantic when transferring ownership.
    ...
    auto myChatBot = ChatBot("../images/chatbot.png");
